...
PMA_messages['strDropTableStrongWarning'] = "Está prestes a DESTRUIR a tabela completa!";
PMA_messages['strTruncateTableStrongWarning'] = "Está prestes a TRUNCAR a tabela completa!";
PMA_messages['strDeleteTrackingData'] = "Eliminar os dados de rastreamento para esta tabela?";
PMA_messages['strDeleteTrackingDataMultiple'] = "Eliminar os dados de rastreamento para estas tabelas?";
PMA_messages['strDeleteTrackingVersion'] = "Eliminar os dados de rastreamento para esta versão?";
PMA_messages['strDeleteTrackingVersionMultiple'] = "Eliminar os dados de rastreamento para estas versões?";
PMA_messages['strDeletingTrackingEntry'] = "Eliminar a entrada do relatório de rastreamento?";
PMA_messages['strDeletingTrackingData'] = "A eliminar os dados de rastreamento";
PMA_messages['strDroppingPrimaryKeyIndex'] = "Eliminando Chave Primária/Índice";
...
PMA_messages['strConfirmNavigation'] = "Tem alterações não gravadas; tem a certeza que deseja sair desta página?";
PMA_messages['strConfirmRowChange'] = "Está a tentar reduzir a quantidade de linhas, mas já inseriu dados nessas linhas que serão perdidas. Deseja continuar?";
...
PMA_messages['strColumnName'] = "Nome da coluna";
